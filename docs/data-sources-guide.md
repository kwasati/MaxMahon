...
7. **[RESOLVED 2026-05-22]** **SETSMART EOD `close` is "adjusted" by default** (`adjustedPriceFlag="Y"` — `scripts/setsmart_adapter.py:78`). For DPS x price compatibility audits this is fine; for raw historical comparisons it matters.
   *Fix applied in plan: data-sources-cleanup*
