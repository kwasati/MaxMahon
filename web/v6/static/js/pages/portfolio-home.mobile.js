...
async function _saveTabName(root, nm) {
  ...
  if (!name) { nm.textContent = pid; return; }
  try {
  ...
  return (
    '<div class="pf-wrap">' +
      ...
      '<div class="pf-card">' +
        '<div class="pf-card-h">' +
          '<h2>พอร์ตของกู</h2>' +
          '<span class="hint">กรอกจำนวนหุ้นในช่อง แล้วกดบันทึก · แท่ง = จริง ขีด = เป้า</span>' +
        '</div>' +
        ...
        '</table></div>' +
        '<div class="pf-card-f">' +
          '<span class="note">เงินสดกรอกเป็นบาท</span>' +
      ...
      '<div class="pf-card">' +
        '<div class="pf-card-h">' +
          '<h2>มีเงินมาเพิ่ม</h2>' +
          '<span class="hint">เติมเฉพาะตัวที่ขาดเป้า · ตัวเกินไม่ต้องซื้อ</span>' +
        '</div>' +
        '<div class="topup-in">' +
